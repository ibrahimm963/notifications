...
import 'package:ffbau_site/Pages/ArtikelPage/prufung.dart';
import 'package:ffbau_site/Pages/ArtikelPage/schulung.dart';
import 'package:ffbau_site/info.dart'; // Assuming WebColors is defined here.
        ...
        child: MouseRegion(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: isSelected
                  ? WebColors().companyColor2 // Change color if selected
                  : WebColors().companyColor1.withOpacity(0),
