  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Text("Unsere Leistungen für Sie",
          style: TextStyle(
          ...
          Padding(
            ...
            child: SizedBox( width: 1400, height: 400,
              child: Card(
                color: Colors.blueAccent,
                child: Row(
                  children: [
                    ...
                    child: Column(
                      children: [
                        const SizedBox(height: 76.8, width: 250,
                        child: Column(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ElevatedButton(onPressed: () {},
                              ...
                              child: const Text("Termin vereinbaren",
                                  style: TextStyle(
                                      color: Colors.blueAccent,
