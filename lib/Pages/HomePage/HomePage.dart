        ...
        children: [
              ...
              child: Row(
                children: [
                  ...
                  ElevatedButton(onPressed: () {},
                      ...
                      child: const Text("Werde Teil des Teams",
                          style: TextStyle(
                              color: Colors.blueAccent,
                              fontWeight: FontWeight.w600
                          ))
          ...
          Stack(
            children: [
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 636,
                      ...
                      children: [
                        const Text("Dr. Soufian El-Fouzari\nAkhi Al Karim",
                        style: TextStyle(
                          fontSize: 60,
                          fontWeight: FontWeight.bold,
                          color: Colors.blueAccent
                        ),),
                        const Text("Facharzt der Allgemeinmedizin",
                          style: TextStyle(
                              fontSize: 40,
                              fontWeight: FontWeight.bold,
                              color: Colors.blueAccent
                          ),),
                        const Text("Ihre Gesundheit on besten Händern",
                          style: TextStyle(
                              fontSize: 30,
                              fontWeight: FontWeight.bold,
                              color: Colors.blueAccent
              ...
              SizedBox(width: 1272, height: 1050,
                  child: Column(
                      ...
                      Material(
                        elevation: 20,
                          child: Container(
                            ...
                            child: const Padding(
                              padding: EdgeInsets.only(right: 38.0, left: 38.0, top: 20),
                              child: Column(
                                children: [
                                  Center(
